class CrudmaticController < ApplicationController
  rescue_from ActiveRecord::RecordNotFound, :with => :record_not_found
  include CrudmaticHelper

  append_view_path File.join(Crudmatic::Engine.root, 'app', 'views', 'crudmatic')
  ...
  class << self
    ...
    def inherited(child)
      super(child)
      child.crud_actions = [:show, :create, :edit, :delete]
    end
  end
